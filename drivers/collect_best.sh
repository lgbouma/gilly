...
cp ../results/M15rot_A19gyroage/cks-VII_period_vs_cks-VII_prad_gyroagecolors.png $o/03.png
cp ../results/M15rot_A19gyroage/cks-VII_rp_vs_gyroage_log.png $o/04.png

#cp ../results/cdf_rp_agecut_KS_test/cdf_Rp_KS_cut0.7_protM15_gyroA19.png $o/06.png
cp ../results/cdf_rp_agecut_KS_test/cdf_Rp_KS_cut1.0_protM15_gyroA19.png $o/05.png

# cp ../results/hist_rp_agecut/hist_Rp_cut0.7_protM15_gyroA19.png $o/08.png
cp ../results/hist_rp_agecut/hist_Rp_cut1.0_protM15_gyroA19.png $o/06.png
